...
clm_obj = CorrelatedLinearModel(
    n=n, noise=0.1, mean_vec=mean_vec, Sigma=Sigma, beta=beta, random_state=1234
)
...
for lambda_sv in lambda_sv_ls:
    krr_reg = ShapleyRegulariser(
        lambda_sv=lambda_sv, lambda_krr=1e-2, lambda_cme=1e-3, n_components=600
    )
